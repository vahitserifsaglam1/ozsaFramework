<?php
     ...
     include "app/Configs/Interfaces/SessionInterface.php";
   ...
   class Session implements SessionInterface
   {
        ...
        */
       private $sessionType = 'Php';
       /**
        * @var string
        * Desteklenen 'md5','sha1' ...
        */
       private $nameHast = 'md5';

       public $sessionFolder = 'Sessions/';

       public static function init()
       {
           if(!file::check(self::$sessionFolder) ) file::mkdir(self::$sessionFolder);
       }
       ...
       {
           return self::readSessionFile($name,".ozsa");
       }
