...
class RPDO implements Driver
{
	 ...
	 * @param string  $useroptional, usename to sign in
	 * @param string  $passoptional, password for connection login
	 *
	 */
...
class OODBBean implements\IteratorAggregate,\ArrayAccess,\Countable
{
	 ...
	 *
	 * @param string$typename of the list you want to retrieve
	 * @param OODB  $oodbThe RB OODB object database instance
	 *
	 * @return array
	 */
	...
	*/
	 ...
	 *
	 * @param string $sqlSQL to be added to retrieval query (prefixed by AND)
	 * @param array  $bindings array with parameters to bind to SQL snippet
	 *
	 * @return OODBBean
	 */
...
abstract class Observable { //bracket must be here - otherwise coverage software does not understand.
	 ...
	 * @param mixed  $infomessage object to send along
	 *
	 * @return void
	 */
...
interface Observer
{
	 ...
	 * 
	 * @param string $eventname event identifier
	 * @param mixed  $beana message sent along with the notification
	 *
	 * @return void
	 */
...
interface QueryWriter
{
	 ...
	 * This methods accepts a type and infers the corresponding table name.
	 *
	 * @param string  $typename of the table
	 ...
	 * @param integer $datatypetarget data type
	 *
	 * @return void
	 */
	 ...
	 * @param array  $bindingsbindings for SQL snippet
	 *
	 * @return array
	 */
	 ...
	 * @param string $destTypedestination type, the target type you want to get beans of
	 ...
	 * @param string $destTypedestination type, the second part of the link you're looking for
	 * @param string $sourceIDID for the source
	 ...
	 * @param boolean $allif TRUE only return records that have been associated with ALL the tags in the list
	 * @param string  $addSqladdition SQL snippet, for pagination
	 ...
	 * This methods accepts a type and infers the corresponding table name.
	 *
	 * @param string  $typename of the table to update
	 ...
	 *
	 * @param string $sourceType source type
	 * @param string $destTypedestination type
	 * @param string $sourceIDsource ID
	 *
	 * @return void
	 */
	 ...
	 * This methods accepts a type and infers the corresponding table name.
	 *
	 * @param string $typetype to add index to
	 * @param string $namename of the new index
...
abstract class AQueryWriter { //bracket must be here - otherwise coverage software does not understand.
	 ...
	 * @param integer $offsetstart counter at...
	 *
	 * @return string
	 */
	 ...
	 * @param string $keykey to use for lookup
	 *
	 * @return mixed
	 */
	 ...
	 * @param string $keykey
	 * @param array  $valuescontent to be stored
	 *
	 * @return void
	 */
	 ...
	 * @param array  $bindingsparameter bindings for SQL snippet
	 ...
	 * @param string  $destTypetype of the bean you want to obtain using the relation
	 ...
	 *
	 * @param string $tabletable to perform query on
	 ...
	 *
	 * @param string  $columncolumn to be escaped
...
abstract class Repository
{
	 ...
	 * @param string  $propertyproperty that contains the embedded bean
	 * @param OODBBean $valueembedded bean itself
	 */
	 ...
	 * @param array  $bindingswhether you prefer to use a WHERE clause or not (TRUE = not)
	 *
	 * @return array
	 *
	 * @throws SQL
	 ...
	 * @param string $addSQLadditional SQL snippet
...
class Fluid extends Repository
{
	 ...
	 * @param string  $numbernumber of beans you would like to get
	 ...
	 * @param integer $idID of the bean you want to load
	 *
	 * @throws SQL
	 *
	 * @return OODBBean
...
/**
 * @fileRedBean/ToolBox.php
 * @descA RedBeanPHP-wide service locator
 * @author Gabor de Mooij and the RedBeanPHP community
 * @licenseBSD/GPLv2
 *
 * ToolBox.
...
class Finder
{
	 ...
	 *
	 * @param string $type  typethe type of bean you are looking for
	 * @param string $sqlsql SQL query to find the desired bean, starting right after WHERE clause
	 ...
	 * @param string $sqlSQL query to find the desired bean, starting right after WHERE clause
	 * @param array  $bindings values array of values to be bound to parameters in query
	 *
	 * @return OODBBean
	 */
...
class AssociationManager extends Observable
{
	 ...
	 * @param string  $sqladditional SQL snippet
	 ...
	 * @param string  $sqlSQL snippet (optional)
	 ...
	 *
	 * @param OODBBean|array $beanthe bean you have
	 * @param string  $typethe type of beans you want
	 * @param string  $sql SQL snippet for extra filtering
	 * @param array$bindings  values to be inserted in SQL slots
	 * @param boolean $gluewhether the SQL should be prefixed with WHERE
	 *
	 * @return array
	 */
...
class TagManager
{
	 ...
	 * @param string $sqladditional SQL (use only for pagination)
	 * @param array  $bindings bindings
	 *
	 * @return array
	 */
...
class LabelMaker
{
	 ...
	 * individual bean.
	 *
	 * @param string $typetype of beans you would like to have
...
class Facade
{
	 ...
	 * @throws SQL
	 *
	 * @param string $methoddesired query method (i.e. 'cell', 'col', 'exec' etc..)
	 * @param string $sqlthe sql you want to execute
	 ...
	 *
	 * @param string  $dsnDatabase connection string
	 * @param string  $username Username for database
	 * @param string  $password Password for database
	 * @param boolean $frozenTRUE if you want to setup in frozen mode
	 *
	 * @return ToolBox
	 */
	 ...
	 * @param string$userUser for connection
	 * @param NULL|string $passPassword for connection
  ...
  'sqlsrv' => 'SQLServer',
	...
	*/
	 ...
	 *
	 * @param string|array $typeOrBeanArraytype or bean array to import
	 * @param integer$numbernumber of beans to dispense
	 * @param boolean	  $alwaysReturnArray if TRUE always returns the result as an array
	 *
	 * @return array|OODBBean
	 *
	 ...
	 *
	 * @param string  $ordera description of the desired dispense order using the syntax above
	 ...
	 * @param  string $sqlSQL code for finding the bean
	 * @param  array  $bindings parameters to bind to SQL
	 *
	 * @return array
	 */
	 ...
	 * @param boolean  $pidfor internal usage
	 ...
	 *
	 * @param array|OODBBean $beansbeans to be exported
	 ...
	 * @param string $sqladditional SQL
	 * @param array  $bindings bindings
	 *
	 * @return array
	 */
	 ...
	 *
	 * @param  string $tablename of the table (not type) you want to get columns of
	 *
	 * @return array
	 */
	 ...
	 * @param callable $callablea PHP callable
	 */
...
class DuplicationManager
{
	 ...
	 *
	 * @param OODBBean $copytarget bean to copy lists to
	 ...
	 *
	 * @param string $typebean type to get list for
	 ...
	 *
	 * @param OODBBean $bean bean to be copied
	 * @param array$trailtrail to prevent infinite loops
	 * @param boolean $preserveIDspreserve IDs
	 *
	 * @return OODBBean
	 */
...
/**/
	 ...
	 *
	 * @param OODBBean $bean bean to be copied
	 * @param array$trailfor internal usage, pass array()
	 * @param boolean $preserveIDsfor internal usage
	 *
	 * @return OODBBean
	 */
	 ...
	 * @param boolean  $parentsalso export parents
	 * @param array $filtersonly these types (whitelist)
	 * @param string$caseStyle case style identifier
	 *
	 * @return array
	 */
